...
public class CustomEditViewBold extends android.support.v7.widget.AppCompatEditText
{
	private Typeface tf;
	//public  final String DEFAULT_FONT = "fonts/Rimouski.otf";
	public  final String DEFAULT_FONT = "fonts/lato_bold.ttf";
	public CustomEditViewBold(Context context)
	{
		super(context);
		if (!isInEditMode())
			init(null);
	}
	public CustomEditViewBold(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		if (!isInEditMode())
			init(attrs);
	...
	public CustomEditViewBold(Context context, AttributeSet attrs, int defStyle)
	{
